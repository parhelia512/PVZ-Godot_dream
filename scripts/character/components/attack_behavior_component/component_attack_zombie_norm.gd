...
func owner_update_speed(speed_product:float):
	change_attack_value(speed_product, E_AttackValueFactor.Speed)

## 修改攻击值
func change_attack_value(value:float, influence_factor:E_AttackValueFactor):
